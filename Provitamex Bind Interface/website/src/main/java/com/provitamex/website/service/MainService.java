...
public class MainService {
	 ...
	 */
	public String setOrder(String mode, String id,String addressId,String clientId,String locationId,String pricelistId,String warehouseId,List<Product2> products,String comments) {
		Date date= new Date();
	...
	/*
	 * Method called to delete an order
	 * Params: Id of order to be deleted
	 * Return: Success/Error message
	 */
	public String deleteOrder(String id) {
		String result;
		try {
			apiservice.deleteRequest("https://api.bind.com.mx/api/Orders/"+id);
			result="Success";
		} catch(Exception e) {
			logger.error("An error occured while deleting order. Full stack trace: ",e);
			e.printStackTrace();
			result="Error";
		}
		return result;
	...
	/*
	 * Method called to delete a client
	 * Params: Id of client to be deleted
	 * Return: Success/Error message
	 */
